...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['descripcion']) || empty($_POST['cantidad']) || empty($_POST['precio']) || empty($_POST['color']) || empty($_POST['tamaño']) || empty($_FILES['foto']['name'])) {
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['foto'])) {
            ...
            if (move_uploaded_file($_FILES['foto']['tmp_name'], $rutaArchivo)) {
                ...
                $consulta = mysqli_query($conexion, "INSERT INTO productos (nombre, descripcion, cantidad, precio, color, tamaño, foto, idcat) VALUES ('$nombre', '$descripcion', '$cantidad', '$precio', '$color', '$tamaño', '$foto', '$idcat')");
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($datos['tamaño']); ?></td>
                    <td>
    <?php
