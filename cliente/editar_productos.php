...
if (!empty($_POST)) {
  ...
  if (empty($_POST['nombre']) || empty($_POST['descripcion']) || empty($_POST['cantidad']) || empty($_POST['precio']) || empty($_POST['color']) || empty($_POST['tamaño']) || empty($_POST['foto']) || empty($_POST['idcat'])) {
    $alert = '<div class="alert alert-danger" role="alert">Todos los campos son requeridos</div>';
            ...
            $sql_update = mysqli_query($conexion, "UPDATE productos SET nombre='$nombre', descripcion='$descripcion', cantidad='$cantidad', precio='$precio', color='$color', tamaño='$tamaño', foto='$foto', idcat='$idcat' WHERE idprod=$idprod");
    ...
    <div class="col-lg-6 m-auto">
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <input type="number" placeholder="Ingrese tamaño" class="form-control" name="tamaño" id="tamaño" value="<?php echo $tamaño; ?>">
        </div>
        <div class="form-group">
        ...
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="window.location.href='productos.php'">Cancelar</button>
